...
class Icon(Link):
    ...
    @gx_params.setter
    def gx_params(self, value: Optional[GxParams]):
    ...
    def build_kml(self, root: etree.Element, with_children=True):
        ...
        if self._refresh_interval is not None:
            etree.SubElement(root, 'refreshInterval').text = f'{self._refresh_interval:0.1f}'
    ...
    def __init__(
        ...
        Link.__init__(self, href=href, refresh_mode=refresh_mode, refresh_interval=refresh_interval)
        self._gx_params = gx_params
