...
class Geometry(Object, ABC):
    ...
    The :class:`~pyLiveKML.KML.KMLObjects.Geometry` class is the abstract base class
    for KML :class:`~pyLiveKML.KML.KMLObjects.Object` instances that have an existence
    as geospatial objects in GEP and that are children of
    :class:`~pyLiveKML.KML.KMLObjects.Placemark` instances.
    """
