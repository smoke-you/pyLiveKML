...
def load_adsb_exchange_data(filename: str) -> list[AircraftData]:
...
def load_gep():
    gep_loader.name = 'Aircraft Trail Demonstrator'
...
def main():
    # set this value to suit
    trail_length = 6
    # load the trails
    gep_sync.container.append(
        AircraftTrail(load_adsb_exchange_data('..\\aircraft_data\\N921DU-2022-02-01.json'), trail_length)
    )
    gep_sync.container.append(
        AircraftTrail(load_adsb_exchange_data('..\\aircraft_data\\B1616-2022-02-01.json'), trail_length)
    )
    gep_sync.container.append(
        AircraftTrail(load_adsb_exchange_data('..\\aircraft_data\\PH-BXC-2022-02-01.json'), trail_length)
    )
